export default {
  ...
  'rule.management.size.large': 'Large',
  // actions
  'rule.management.actions.refresh': 'refresh',
  'rule.management.actions.density': 'density',
  'rule.management.actions.columnSetting': 'Column Setting',
};
